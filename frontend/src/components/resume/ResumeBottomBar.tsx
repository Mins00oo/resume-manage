...
export default function ResumeBottomBar({ completion, onSave, onSettings, onMore, saving, saved }: Props) {
  return (
    <div
      className="fixed left-0 right-0 bottom-[60px] md:bottom-0 z-30 border-t"
      style={{
    ...
    >
      ...
      <div className="px-4 py-2.5 flex items-center gap-2">
        <button
          type="button"
          onClick={onSettings}
          className="w-10 h-10 rounded-xl border border-[var(--color-border-subtle)] flex items-center justify-center text-[var(--color-text-secondary)] hover:bg-[var(--color-bg-muted)] transition-colors"
        >
