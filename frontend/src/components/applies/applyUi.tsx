...
import type { mockApplies } from '../../mocks/data';
import { statusLabel } from '../../lib/statusLabel';

export type ApplyItem = (typeof mockApplies)[number];
...
export function dDayLabel(deadline: string | null, ref = new Date('2026-04-15')) {
  if (!deadline) return null;
  const diff = Math.round(
    (new Date(deadline).getTime() - ref.getTime()) / (24 * 60 * 60 * 1000),
  );
